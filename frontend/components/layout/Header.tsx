  ...
  return (
    <>
      <header className="px-4 md:px-8 py-3 md:py-4 flex justify-between items-center relative z-20 overflow-hidden shadow-[0_4px_30px_rgba(0,0,0,0.3)] border-b border-[var(--color-text-primary)]/10 print:hidden">
        <div 
          className="absolute inset-0 bg-gradient-to-r from-cyan-500/20 via-red-500/20 to-cyan-500/20 bg-[length:200%_200%] animate-[gradientBG_8s_ease_infinite] z-0 pointer-events-none backdrop-blur-3xl"
        />
        
        <Link href="/" className="relative flex items-center justify-center z-10">
