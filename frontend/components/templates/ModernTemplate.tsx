export function ModernTemplate({ data }: { data: any }) {
  ...
  return (
    <div className="w-full bg-white text-gray-900 p-8 font-sans" style={{ fontSize: "11pt" }}>
      <div className="flex justify-between items-end border-b-2 pb-3 mb-4" style={{ borderColor: "#14B8A6" }}>
        <div>
      ...
      {summary && (
        <div className="mb-4">
          <h2 className="text-base tracking-wide font-bold uppercase mb-1.5" style={{ color: "#14B8A6" }}>Summary</h2>
      ...
      {experience.length > 0 && (
        <div className="mb-4">
          <h2 className="text-base tracking-wide font-bold uppercase mb-1.5" style={{ color: "#14B8A6" }}>Work Experience</h2>
          <div className="flex flex-col gap-3">
            {experience.map((exp: any, i: number) => (
              <div key={i}>
                ...
                <div className="italic text-sm text-gray-600 mb-0.5">{exp.company}</div>
      ...
      {education.length > 0 && (
        <div className="mb-4">
          <h2 className="text-base tracking-wide font-bold uppercase mb-1.5" style={{ color: "#14B8A6" }}>Education</h2>
          <div className="flex flex-col gap-3">
      ...
      {projects.length > 0 && (
        <div className="mb-4">
          <h2 className="text-base tracking-wide font-bold uppercase mb-1.5" style={{ color: "#14B8A6" }}>Projects</h2>
          <div className="flex flex-col gap-3">
            {projects.map((proj: any, i: number) => (
              <div key={i}>
                ...
                {(proj.link || proj.tools) && (
                  <div className="italic text-sm text-gray-600 mb-0.5 flex flex-wrap items-center gap-1">
      ...
      {certifications.length > 0 && (
        <div className="mb-4">
          <h2 className="text-base tracking-wide font-bold uppercase mb-1.5" style={{ color: "#14B8A6" }}>Certifications</h2>
            ...
            {certifications.map((cert: any, i: number) => (
              <div key={i} className="text-sm text-gray-800">
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-500 font-normal">{formatDate(cert.date)}</span>
                </div>
      ...
      {skills.length > 0 && (
        <div className="mb-4">
          <h2 className="text-base tracking-wide font-bold uppercase mb-1.5" style={{ color: "#14B8A6" }}>Skills</h2>
